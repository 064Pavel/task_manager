<template>
    ...
    <div class="mt-12 grid gap-10 overflow-y-auto h-[620px]">
        <div v-for="task in tasks"
            ...
            <div class="flex flex-row justify-between w-[100px]">
                <div>
                    <img
                        class="w-10"
    ...
    <div class="relative top-16 left-24">
        <router-link :to="{name: 'tasks.create'}">
            <button class=" w-[300px] bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-8 rounded-2xl">+ ADD TASK</button>
        </router-link>
    </div>
